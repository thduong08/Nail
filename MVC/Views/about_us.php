...
<body>
  ...
  <section class="nail-header">
    ...
    <!--body-->
    <div class="nail-story">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-4">
            <img src="../../img/image_aboutus/anh2.jpg" alt="">
          </div>
          <div class="col-md-4" style="background-color: #dca8a8">
            <div style="padding-top: 200px; padding-left: 70px;">
              <h1 style="font-size:30px; color: #fff">More than a Mani</h1><br>
              <a href="http://localhost/Project_nailart/MVC/Views/Shop.php?CategoryID=2"><button type="button" class="btn-book-now2 rounded-5">Shop</button></a>
              <a href="book_now.php"><button type="button" class="btn-book-now2 rounded-5">Book Now</button></a>
            </div>
          </div>
          <div class="col-md-4">
            <img src="../../img/image_aboutus/anh1.jpg" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      <div class=" box rich-text color-background-1 gradient rich-text--full-width">
        <div class="rich-text__blocks">
          <h2>Empowerment is beautiful.</h2><br>
          <div class="rich-text__text rte">
            <p>
              Nail Spa was founded with a vision to
              <strong>radically change the nail care industry</strong>
              through a brand committed to the highest quality self-care services, safer and more sustainable products, and cleaner studio environments and practices. Our platform was built with intention to create greater opportunities for one of the largest workforces of women and immigrants. From the beginning, our focus has been on
              <strong>doing what is best, not what is standard</strong>
              .
            </p>
            <p>
              Our services and products at Nail Spa exist to reveal and amplify your true self, not conceal or hide, and never to harm. Our technologies, skill-building programs, and standards are
              <strong>empowering a new generation of artists</strong>
              , creators, and entrepreneurs to live their fullest story. These team members are united by a collective passion for self-care that’s bigger than self, and beauty you can feel as much as you see. We celebrate their craft and economic independence, and proudly give all team members the potential for
              <strong>equity ownership in our company</strong>
              .
            </p>
            <p>Welcome to Nail Spa and thank you for supporting our community.</p>
            <p>Team Nail Spa</p>
          </div>
        </div>
      </div>
