        ...
        <div class="regiter-container">
          <div class="row justify-content-around">
            ...
            <form action="" class="col-md-5 bg -light p-3 my-1" method="POST">
              ...
              <div class="form-group mb-4">
                <input type="email" name="email" id="email" class="form-control" placeholder="Email" title="Please enter a valid Gmail address" required>
              </div>
              <div class="form-group mb-4">
                <input type="tel" name="phone" id="phone" class="form-control" placeholder="Phone" pattern="[0-9]{10}" title="Phone number must be exactly 10 digits" required>
              </div>

              <div class="form-group mb-4">
                <input type="text" name="username" id="username" class="form-control" placeholder="Username" required pattern="[a-zA-Z0-9]{6,20}" title="Username must be 6-20 characters and contain no spaces or special characters." />
              </div>
              <div class="form-group mb-4">
