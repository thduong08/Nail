...
<body class="bg-info" >
<nav class="navbar navbar-expand-lg bg-danger-subtle" style="background-color: #dca8a8;">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">NAIL CARE</a>
            </li>
    ...
    <footer class="py-3 my-4 bg-danger-subtle" style="background-color: #dca8a8;">
