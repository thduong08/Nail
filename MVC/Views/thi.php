    ...
    <div class="container-fluid py-3">
      <div class="row">
        <div class="col-md-5 d-none d-md-block">
          <div class="row">
            <div class="col-md-4 text-center"><a href="index.php?act=booknow"><button type="button" class="btn bg-danger-subtle rounded-5 lh-lg">BOOK NOW</button></a></div>
            <div class="col-md-8 pt-1 p-0 lh-lg"><a href="index.php?act=service" class=""> SERVICE</a></div>
          </div>
        </div>
      ...
      <div id="carouselExampleControls" class="carousel slide" data-mdb-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../../img/image/nail5.webp" class="d-block w-100" alt="Wild Landscape" />
          ...
          <div class="carousel-item">
            <img src="../../img/image/nail1.jpg" class="d-block w-100" alt="Camera" />
            <div class="carousel-caption">
              <div class="mb-5">
                <h1>Nail Your </h1>
                <h1>Nail Narrative</h1>
          ...
          <div class="carousel-item">
            <img src="../../img/image/nail2.jpg" class="d-block w-100" alt="Exotic Fruits" />
            <div class="carousel-caption">
              <div class="mb-5">
                <h1>Nail Your </h1>
                <h1>Nail Narrative</h1>
        ...
        <div class="row">
          <div class="col-md-5">
            ...
            <div class="row my-3">
              ...
              <div class="col-md-4">
                <a href="#"><button class="btn bg-danger-subtle rounded-5">Book Now</button></a>
              </div>
            </div>
            <div class="row my-3">
              <div class="col-md-8 ">
