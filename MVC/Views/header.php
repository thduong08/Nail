      ...
      <div class="row">
        <div class="col-md-5 d-none d-md-block">
          <div class="row">
            ...
            <div class="col-md-8 pt-1 p-0 lh-lg"><a href="index.php?act=service" style="text-decoration: none; color: black"> SERVICE</a></div>
          </div>
        </div>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <a class="nav-link dropdown-toggle" href="index.php?act=shop" role="button" data-bs-toggle="dropdown"
            ...
            <li class="nav-item px-2">
              <a class="nav-link" aria-current="page" href="index.php?act=nail-art">Nail Art</a>
            </li>
            <li class="nav-item px-2">
              <a class="nav-link" aria-current="page" href="index.php?act=gift-card">Gift Card</a>
            </li>
            <li class="nav-item px-2">
              <a class="nav-link" aria-current="page" href="index.php?act=policies">Policies</a>
            </li>
            <li class="nav-item px-2">
              <a class="nav-link" aria-current="page" href="index.php?act=our-diference">Our diference</a>
            </li>
            ...
            <li class="nav-item dropdown px-2">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="index.php?act=location">Location</a></li>
                <li><a class="dropdown-item" href="index.php?act=contact-us">Contact us</a></li>
                <li><a class="dropdown-item" href="index.php?act=faq">FAQ</a></li>
              </ul>
            </li>
          </ul>
        </div>
